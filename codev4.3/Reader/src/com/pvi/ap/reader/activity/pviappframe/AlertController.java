...
public class AlertController {
    ...
    private static final String TAG = "PviAlertController";
    ...
    private static int mWinWidth = 400;//限定弹出框窗口宽度，默认400
    ...
    private int mMessageViewGravity = -1;
    ...
    public void installContent() {
        ...
        mWindow.setContentView(R.layout.alert_dialog_pviapp_ui1);      
        setupView();
    }
    ...
    public void setMessage(CharSequence message,int gravity) {
        //Logger.d(TAG,"gravity:"+gravity);
        mMessage = message;
        if(gravity>-1){
            mMessageViewGravity = gravity;
        }
        if (mMessageView != null) {
    ...
    private void setupView() {
        ...
        if(mWinWidth>0){
            ...
            //Logger.d(TAG,"window width:"+mWinWidth);
        }else{
            //Logger.d(TAG,"window width<0 ,is "+mWinWidth);
        }
        //恢复默认宽度
        mWinWidth = 400;
...
/*
        ...
        // 增加关闭按钮
                ...
                iv.setBackgroundResource(R.drawable.ic_dialog_close_ui2);
    ...
    private boolean setupTitle(LinearLayout topPanel) {
        ...
        if (mCustomTitleView != null) {
            ...
            if (hasTextTitle) {
                ...
                //mIconView.setImageResource(R.drawable.ic_dialog_menu_generic_pviapp);
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        if (mMessage != null) {
            if(mMessageViewGravity>-1){
                mMessageView.setGravity(mMessageViewGravity);
            }
    ...
    private boolean setupButtons() {
        ...
        if(app.deviceType==1){
            mButtonPositive.setUpdateMode(View.EINK_WAIT_MODE_NOWAIT | View.EINK_WAVEFORM_MODE_DU | View.EINK_UPDATE_MODE_PARTIAL);
            mButtonNegative.setUpdateMode(View.EINK_WAIT_MODE_NOWAIT | View.EINK_WAVEFORM_MODE_DU | View.EINK_UPDATE_MODE_PARTIAL);
            mButtonNeutral.setUpdateMode(View.EINK_WAIT_MODE_NOWAIT | View.EINK_WAVEFORM_MODE_DU | View.EINK_UPDATE_MODE_PARTIAL);
        }*/
 ...
 /*       
        ...
        int fullDark = a.getResourceId(
                R.styleable.AlertDialog_fullDark, R.drawable.popup_full_dark_pviapp);
        int topDark = a.getResourceId(
                R.styleable.AlertDialog_topDark, R.drawable.popup_top_dark_pviapp);
        int centerDark = a.getResourceId(
                R.styleable.AlertDialog_centerDark, R.drawable.popup_center_dark_pviapp);
        int bottomDark = a.getResourceId(
                R.styleable.AlertDialog_bottomDark, R.drawable.popup_bottom_dark_pviapp);
        int fullBright = a.getResourceId(
                R.styleable.AlertDialog_fullBright, R.drawable.popup_full_bright_pviapp);
        int topBright = a.getResourceId(
                R.styleable.AlertDialog_topBright, R.drawable.popup_top_bright_pviapp);
        int centerBright = a.getResourceId(
                R.styleable.AlertDialog_centerBright, R.drawable.popup_center_bright_pviapp);
        int bottomBright = a.getResourceId(
                R.styleable.AlertDialog_bottomBright, R.drawable.popup_bottom_bright_pviapp);
        int bottomMedium = a.getResourceId(
                R.styleable.AlertDialog_bottomMedium, R.drawable.popup_bottom_medium_pviapp);
        int centerMedium = a.getResourceId(
                R.styleable.AlertDialog_centerMedium, R.drawable.popup_center_medium_pviapp);
...
//        }
    ...
    public static class AlertParams {
        ...
        public int mWinWidth = 400;//限定对话框宽度，默认400dp
        ...
        private void createListView(final AlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.select_dialog_pviapp, null);
            ListAdapter adapter;
            
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.select_dialog_multichoice_pviapp, R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.select_dialog_multichoice_pviapp,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice 
                        ? R.layout.select_dialog_singlechoice_pviapp : R.layout.select_dialog_item_pviapp;
                if (mCursor == null) {
     ...
     * @param mWinWidth2
     */
    public void setWinWidth(int mWinWidth2) {
        // TODO Auto-generated method stub
        mWinWidth = mWinWidth2;
    }
    ...
    public void setBackgroundTransparent(boolean backgroundTransparent) {
        mBackgroundTransparent = backgroundTransparent;
    }
}
