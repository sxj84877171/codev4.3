...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    protected AlertDialog(Context context) {
        this(context, R.style.Theme_Dialog_PviAlert);
    }
...
/*    protected AlertDialog(Context context, int theme, int skinID) {
        super(context, theme);
        this.skinID = skinID;
        mAlert = new AlertController(context, this, getWindow());
    }*/
    ...
    public void setBackgroundTransparent(boolean backgroundTransparent) {
        mAlert.setBackgroundTransparent(backgroundTransparent);
    }
    ...
    public static class Builder {
         ...
         * 设置对话框窗口限定宽度
         */
        public Builder setWinWidth(int winWidth) {
            P.mWinWidth = winWidth;
            return this;
        }
