 ...
 */
public class SoundSetActivity extends PviActivity {
	 ...
	 * 状态
	 */
	public final static String  STATE = "SoundSet";
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    class MyThread implements Runnable{
	    	...
	    	public void run(){
	    		...
	    		//初始化UI
	    		m_openButton = (RadioButton)findViewById(R.id.sound_open);
	    		m_closeButton = (RadioButton)findViewById(R.id.sound_close);
	    		m_okButton = (Button)findViewById(R.id.sound_ok);
	    		m_returnButton = (Button)findViewById(R.id.sound_return);
	    		m_popPrompt = (LinearLayout)findViewById(R.id.sound_popPrompt);
	    		m_popPrompt_close = (ImageView)findViewById(R.id.sound_popPrompt_close);
	    		m_popPrompt_context = (TextView)findViewById(R.id.sound_popPrompt_context);
	    		...
	    		m_okButton.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						...
						if(m_openButton.isChecked()){
							msg = getResources().getString(R.string.sound_set_open_ok);
							//选择设置打开
							...
							msg = getResources().getString(R.string.sound_set_close_ok);
							//选择设置关闭
							//m_popPrompt_context.setText(msg);
							...
							msg = getResources().getString(R.string.sound_set_msg);
							//选择设置关闭
							//m_popPrompt_context.setText(msg);
